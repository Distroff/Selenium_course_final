...
'''
test_guest_cant_see_product_in_basket_opened_from_main_page: собираем из BasePage и №1 basket_page.py 

Гость открывает главную страницу 
Переходит в корзину по кнопке в шапке сайта
Ожидаем, что в корзине нет товаров
Ожидаем, что есть текст о том что корзина пуста 
test_guest_cant_see_product_in_basket_opened_from_product_page: собираем из BasePage и №2 basket_page.py
